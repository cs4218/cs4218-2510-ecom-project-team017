...
| He Ruoqing,Vivien     | `controllers/productController.integration.test.js`                                            | `tests/ui/CategoryProduct.spec.js` <br> `tests/ui/CreateProduct.spec.js` <br> `tests/ui/ProductDetails.spec.js` <br> `tests/ui/Products.spec.js` <br> `tests/ui/UpdateProduct.spec.js`    |                                                                                                                                                 |
